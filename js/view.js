...
var viewController = (function() {
    ...
    function formatNumber(num, type) {
        ...
        */
        ...
        /*
        закомментирован более развернутый способ
    ...
    // getInput - метод, который получает данные и возвращает их в виде объекта (далее их надо получить в контроллере и работать с ними)
    return {
        getInput: getInput,
